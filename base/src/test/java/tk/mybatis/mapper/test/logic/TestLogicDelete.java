...
public class TestLogicDelete {
    ...
    @Test
    public // 删除实体，会带上未删除的查询条件，并忽略实体类给逻辑删除字段设置的值
    ...
    @Test
    public // 根据主键查询，逻辑删除注解查询时会使用未删除的查询条件
    ...
    @Test
    public // 查询所有，逻辑删除注解查询时会使用未删除的查询条件
    void testSelectAll() {
        SqlSession sqlSession = MybatisHelper.getSqlSession();
        try {
            TbUserLogicDeleteMapper logicDeleteMapper = sqlSession.getMapper(TbUserLogicDeleteMapper.class);
    ...
    @Test
    public // 查询数量，会带上未删除的查询条件，并忽略实体类给逻辑删除字段设置的值
    void selectCount() {
        SqlSession sqlSession = MybatisHelper.getSqlSession();
        try {
            TbUserLogicDeleteMapper logicDeleteMapper = sqlSession.getMapper(TbUserLogicDeleteMapper.class);
    ...
    @Test
    public // 根据实体查询，会带上未删除的查询条件，并忽略实体类给逻辑删除字段设置的值
    void testSelect() {
        SqlSession sqlSession = MybatisHelper.getSqlSession();
        try {
            TbUserLogicDeleteMapper logicDeleteMapper = sqlSession.getMapper(TbUserLogicDeleteMapper.class);
    ...
    @Test
    public // Example中没有条件的非正常情况，where条件应只有逻辑删除注解的未删除条件
    void testExampleWithNoCriteria() {
        SqlSession sqlSession = MybatisHelper.getSqlSession();
        try {
            TbUserLogicDeleteMapper logicDeleteMapper = sqlSession.getMapper(TbUserLogicDeleteMapper.class);
            Example example = new Example(TbUserLogicDelete.class);
